...
<h2>입력값 (<c:out value="${msg }"/>)</h2>
 <ul>
 	<li><strong>이름: <c:out value="${ param.name }"></c:out></strong></li>
 	<li><strong>나이: <c:out value="${ param.age }"></c:out></strong></li>
 	<li><strong>이메일: <c:out value="${ param.email }"></c:out></strong></li>
