...
<!-- include directive 가능 -->
<%-- <%@include file="/common/jsp/header.jsp" %> --%>

<!-- action tage -->
 <%-- <jsp:include page="/common/jsp/header.jsp" /> --%>
 <!-- URI로 설정되면 파라미터 받을수 있다. -->
<c:import url="/common/jsp/header.jsp"/><br/>
<c:import url="http://localhost/spring_mvc/common/jsp/header.jsp"/><br/>
<c:import url="http://localhost${pageContext.request.contextPath}/common/jsp/header.jsp"/><br/>
