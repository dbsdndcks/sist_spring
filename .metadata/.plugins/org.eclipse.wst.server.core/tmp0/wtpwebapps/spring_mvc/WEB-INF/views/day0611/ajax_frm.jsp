	...
	$(function(){
		$("#btn").click(function(){
			...
			success: function(jsonObj){
				...
				var sel =$("#sel")[0];
				sel.options[1] = new Option(jsonObj.msg);
				sel.options[2] = new Option(jsonObj.msg2);
			}
...
<h2>AJAX요청</h2>
<div>
<input type="button" id="btn"  value="ajax요청" class="btn btn-success btn-sm">
<input type="button" id="btn2"  value="ajax요청 @ResponseBody" class="btn btn-info btn-sm">
</div>
<div id="output"></div>
<select id="sel">
	<option>------선택------</option>
